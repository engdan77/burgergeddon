...
class Game:
    ...
    def __init__(self):
        ...
        self.IMG_WILMA = pygame.image.load(GAME_PATH + '/img/david.png').convert()
        self.IMG_DANIEL = pygame.image.load(GAME_PATH + '/img/daniel.png').convert()
        self.IMG_ALFONS = pygame.image.load(GAME_PATH + '/img/enemy1.png').convert()
        self.IMG_FIA = pygame.image.load(GAME_PATH + '/img/enemy2.png').convert()
        self.IMG_SLIME = pygame.image.load(GAME_PATH + '/img/fireshot.png').convert()
        self.IMG_POOP = pygame.image.load(GAME_PATH + '/img/supershot.png').convert_alpha()
        self.IMG_HEART = pygame.image.load(GAME_PATH + '/img/heart.png').convert_alpha()
        self.IMG_EXTRA_SLIME = pygame.image.load(GAME_PATH + '/img/extra_fireballs.png').convert_alpha()
        ...
        self.SFX_SHOT = pygame.mixer.Sound(GAME_PATH + "/sfx/gun.ogg")
        self.SFX_BIG_SHOT = pygame.mixer.Sound(GAME_PATH + "/sfx/biggun.ogg")
